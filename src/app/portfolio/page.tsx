...
const projects = [
  ...
  },
  {
    id: "luxecart",
    title: "LuxeCart",
    subtitle: "Luxury E-Commerce Marketplace",
    category: "E-Commerce",
    description:
      "A premium multi-vendor e-commerce marketplace for luxury goods with AR product previews, real-time bidding on exclusive drops, and white-glove delivery tracking.",
    challenge:
      "The client wanted to create a curated luxury marketplace that felt as premium as the products it sold, with authentication verification and exclusive drop mechanics.",
    solution:
      "We built a Next.js storefront with 3D/AR product previews, Stripe Connect for multi-vendor payouts, and a real-time bidding engine for limited-edition drops.",
    results: [
      "$1.2M GMV in first quarter",
      "Average order value: $485",
      "200+ verified luxury sellers",
      "Cart conversion rate: 6.8%",
    ],
    tech: ["Next.js", "TypeScript", "Stripe Connect", "Three.js", "PostgreSQL", "Redis"],
